...
export interface ApiKikitokKikitok extends Struct.CollectionTypeSchema {
  collectionName: 'kikitoks';
  info: {
    description: '';
    displayName: 'kikitok';
    pluralName: 'kikitoks';
    singularName: 'kikitok';
  };
  options: {
...
export interface ApiMessageMessage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    kikitok: Schema.Attribute.Relation<'manyToOne', 'api::kikitok.kikitok'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::message.message'
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::kikitok.kikitok': ApiKikitokKikitok;
